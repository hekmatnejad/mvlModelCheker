...
${OBJECTDIR}/mv_interval.o: mv_interval.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mv_interval.o mv_interval.cpp

${OBJECTDIR}/mvtwaproduct.o: mvtwaproduct.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mvtwaproduct.o mvtwaproduct.cpp
